var Fireworks = function(w,h){
    ...
    self.dt = 0;
		...
		self.canvas.width = self.cw = w;
		self.canvas.height = self.ch = h;
  ...
  self.oneRoundPlease = function(){
  var initialLaunchCount = 30;
...
var fworks = new Fireworks(window.innerWidth,window.innerHeight);
// var gui = new dat.GUI({
// 	autoPlace: false,
// 	load: guiPresets,
// 	preset: 'Default'
